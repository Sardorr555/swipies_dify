const translation = {
  ...
  welcome: '👋 Welcome to Swipies, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Swipies Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Swipies',
  invalid: 'The link has expired',
  explore: 'Explore Swipies',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Swipies and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Swipies Enterprise license for your workspace has expired. Please contact your administrator to continue using Swipies.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Swipies license server. Please contact your administrator to continue using Swipies.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Swipies Enterprise license for your workspace is inactive. Please contact your administrator to continue using Swipies.',
  webapp: {

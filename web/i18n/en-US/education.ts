const translation = {
  ...
  toVerifiedTip: {
    ...
    end: 'for the Swipies Professional Plan.',
  },
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'I confirm I am enrolled or employed at the institution provided. Swipies may request proof of enrollment/employment. If I misrepresent my eligibility, I agree to pay any fees initially waived based on my education status.',
      },
    },
  },
  submit: 'Submit',
  ...
  successTitle: 'You Have Got Swipies Education Verified',
  successContent: 'We have issued a 100% discount coupon for the Swipies Professional plan to your account. The coupon is valid for one year, please use it within the validity period.',
  rejectTitle: 'Your Swipies Educational Verification Has Been Rejected',

const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний Swipies.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API Swipies, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Обновления и обслуживание от Swipies официально',
        4: 'ССО',
        ...
        5: 'Согласованные Соглашения об Уровне Услуг от Swipies Partners',
      },
    ...
    community: {
      features: {
        ...
        2: 'Соблюдает Лицензию на открытое программное обеспечение Swipies',
      },
      name: 'Сообщество',
